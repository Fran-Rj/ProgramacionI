...
namespace PlayMovieSite.View
{
    public partial class Perfil : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Perfil", con))
                {
                    ...
                    if (dr.Read())
                    {
                        ...
                        this.tbNombre.Text = dr["Nombres"].ToString();
        ...
        /*void MetodoOcultarDatos()
        {
            if (informacion.Visible == false)
            {
                informacion.Visible = true;
                BtnGuardarDatos.Visible = true;
                BtnCambiarDatos.Text = "Cancelar";
                lblErrorClave.Text = "";
            }
            else
            {
                ...
                BtnCambiarDatos.Text = "Cambiar datos";
                lblErrorClave.Text = "";
            }
        }*/
        ...
        /*protected void BtnGuardarDatos_Click(object sender, EventArgs e)
        {
            try
            {
                using (con)
                {
                    using (SqlCommand cmd = new SqlCommand("CambiarNombre", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id", SqlDbType.Int).Value = id;
