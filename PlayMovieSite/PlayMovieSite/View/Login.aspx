<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PlayMovieSite.Frm.Login" %>
...
<body>
    ...
    <form id="FrmLogin" runat="server" class="container d-flex justify-content-center align-items-center">
        ...
        <div class="Imagen" >
            <asp:Image runat="server" src="/Imagenes/Neo.png" ID="imagen" Width="100%" Height="420" />
        </div>
